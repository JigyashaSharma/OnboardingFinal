    ...
    return (
        <div className="mx-auto">
            <div>
                ...
                <p>React Dev ops(also known as React.js or ReactJs) is a free and open-source front-end JavaScript library for building user interfaces based on components by Facebook Inc. It is maintained by Meta (formerly Facebook) and a community of individual developers and companies.
                </p>
